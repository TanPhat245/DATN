                  ...
                  onClick={async () => {
                    ...
                    try {
                      const res = await fetch(
                        "http://localhost:5000/api/user/forgot-password/send-code",
                        {
                          method: "POST",
                          headers: { "Content-Type": "application/json" },
              ...
              <>
                ...
                <Button
                  ...
                  onClick={async () => {
                    ...
                    try {
                      const res = await fetch(
                        "http://localhost:5000/api/user/forgot-password/verify-code",
                        {
                          method: "POST",
                          headers: { "Content-Type": "application/json" },
                          body: JSON.stringify({
              ...
              <>
                ...
                <Button
                  ...
                  onClick={async () => {
                    ...
                    try {
                      const res = await fetch(
                        "http://localhost:5000/api/user/forgot-password/reset-password",
                        {
                          method: "POST",
                          headers: { "Content-Type": "application/json" },
                          body: JSON.stringify({
