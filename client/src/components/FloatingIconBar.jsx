  ...
  const fetchCounts = async () => {
    try {
      ...
      const [savedRes, appliedRes] = await Promise.all([
        axios.get("http://localhost:5000/api/user/saved-jobs", headers),
        axios.get("http://localhost:5000/api/user/applications", headers),
      ]);
